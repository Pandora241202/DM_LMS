...
export const es = {
  ...
  [tokens.nav.code]: 'Código',
  [tokens.nav.concepts]: 'Conceptos',
  [tokens.nav.contact]: 'Contacto',
  [tokens.nav.communications]: 'Comunicaciones',
  ...
  [tokens.nav.LM_Manage]: 'Administrar LM',
  [tokens.nav.Account_Manage]: 'Administrar cuenta',
  [tokens.nav.Topic_Manage]: 'Administrar tema',
};
